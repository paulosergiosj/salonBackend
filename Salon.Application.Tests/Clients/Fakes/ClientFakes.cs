...
namespace Salon.Application.Tests.Clients.Fakes
{
    ...
    => new UpdateClientCommand()
    {
        ...
        public static ClientEntity GetClientMike()
            => GetClientEntity(NAME_MIKE, BIRTHDATE_MIKE, CONTACTNUMBER_MIKE, EMAIL_MIKE);

        public static ClientEntity GetClientBob()
           => GetClientEntity(NAME_BOB, BIRTHDATE_BOB, CONTACTNUMBER_BOB, EMAIL_BOB);
